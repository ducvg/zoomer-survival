...
namespace Zoomer.Graphic.Animation
{
	...
	public sealed class CharacterAnimationSO : ScriptableObject
	{
		[field: SerializeField] public ActionAnimation[] Actions;
		public ActionAnimation this[ActionKind actionKind] => Actions[(byte)actionKind];
